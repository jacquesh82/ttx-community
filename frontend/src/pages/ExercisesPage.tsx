      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {isParticipant ? 'Exercices disponibles' : 'Exercices'}
          </h1>
          <p className="text-gray-600">
            {isParticipant 
              ? 'Rejoignez un exercice de crise pour commencer votre mission' 
              : 'Gérez vos exercices de crise'}
          </p>
        </div>
        {!isParticipant && (
          <Link
      ...
      {isParticipant && (
        <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-blue-800 text-sm">
            <strong>Bienvenue dans votre rôle de participant !</strong><br />
            Cliquez sur "Rejoindre" pour accéder à l'interface de l'exercice et commencer votre mission.
            Vous aurez accès à la timeline, la messagerie, le chat équipe et d'autres outils.
          </p>
        </div>
      )}
        ...
        <>
          {deleteMutation.isError && (
            <div className="mb-4 text-sm text-red-600">
              Impossible de supprimer l'exercice. Réessayez.
            </div>
          )}
